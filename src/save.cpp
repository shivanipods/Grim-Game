...
//float cam_x=1.5f,cam_y=-1.2f,cam_z=10.2f;
	if(level==2 && levchanged==0)
	{
...
*/
	...
	void initRendering() {
		...
		Image* image2 = loadBMP("mount.bmp");//pani2
		_textureId3 = loadTexture(image2);

		Image* image3 = loadBMP("wall.bmp");//pani2
